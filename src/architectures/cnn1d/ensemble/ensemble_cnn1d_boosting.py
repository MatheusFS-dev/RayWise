...
def main() -> dict[str, np.ndarray | StandardScaler]:
    ...
    print("\nTraining XGBoost meta-learner on S008 meta-features:")
    xgb_meta = XGBClassifier(
        objective="multi:softprob",
        num_class=len(label_encoder.classes_),
        n_estimators=3,
        learning_rate=0.006002475534604505,
        max_depth=2,
        min_child_weight=2.7129493468547614,
        gamma=0.7843481840054891,
        subsample=0.645319963202127,
        colsample_bytree=0.5234611192616787,
        reg_alpha=0.00020266367334910004,
        reg_lambda=0.0033770158756667623,
