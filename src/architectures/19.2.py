...
def build_model(trial: optuna.Trial, hparams: dict, show_summary: bool = True, t_seed: int = 42) -> tf.keras.Model:
    ...
    x = build_cnn1d(
        ...
        # Filters
        filters_range=trial.suggest_categorical("conv1d_0_filters", [256, 512]),
        # filters_step=40,
        # Kernel size
        kernel_size_range=2,
        # kernel_size_step=1,
    ...
    x = build_cnn1d(
        ...
        # Filters
        filters_range=trial.suggest_categorical("conv1d_1_filters", [256, 512]),
        # filters_step=40,
        # Kernel size
        kernel_size_range=2,
        # kernel_size_step=1,
    ...
    x = build_cnn1d(
        ...
        # Filters
        filters_range=trial.suggest_categorical("conv1d_2_filters", [64, 256, 512]),
        # filters_step=40,
        # Kernel size
    ...
    x = build_cnn1d(
        ...
        # Filters
        filters_range=trial.suggest_categorical("conv1d_3_filters", [128, 256]),
        # filters_step=20,
        # Kernel size
        kernel_size_range=4,
        # kernel_size_step=1,
