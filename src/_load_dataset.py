...
def load_dataset_sparse_labels(s008_path: str = "./data/s008", s009_path: str = "./data/s009"):
    """
    ...
    # Print shapes and all info for the s008_y_train before conversion
    print(f"s008_y_train dtype: {s008_y_train.dtype}")
    print(f"s008_y_train min: {s008_y_train.min()}")
    print(f"s008_y_train max: {s008_y_train.max()}")
    print(f"s008_y_train shape: {s008_y_train.shape}")

    # Print 10 first entries of s008_y_train for inspection
    print("First 10 entries of s008_y_train:")
    print(s008_y_train[:10])

    print("--------------------------------------------------")

    # Cast target beam outputs to float - REMOVING USELESS IMAG PART
    s008_y_train = s008_y_train.astype(np.float32)
    print("After casting to float32:")
    # Print shapes and all info for the s008_y_train before conversion
    print(f"s008_y_train dtype: {s008_y_train.dtype}")
    print(f"s008_y_train min: {s008_y_train.min()}")
    print(f"s008_y_train max: {s008_y_train.max()}")
